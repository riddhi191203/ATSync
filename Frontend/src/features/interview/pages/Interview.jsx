...
const first = (item, keys, fallback = '') =>
  keys.map((key) => item?.[key]).find(Boolean) || fallback
    ...
    <div className='q-card'>
      ...
      >
        ...
        <p className='q-card__question'>
          {first(
            item,
            ['question', 'questionText', 'question_text', 'q', 'prompt'],
        ...
        <div className='q-card__body'>
          ...
          <div className='q-card__section'>
            ...
            <p>
              {first(
                item,
                ['intention', 'intent', 'purpose', 'reason', 'goal'],
          ...
          <div className='q-card__section'>
            ...
            <p>
              {first(
                item,
                ['answer', 'response', 'recommendation', 'solution', 'advice', 'explanation'],
                'No answer provided'
              )}
            </p>
          </div>
...
const Interview = () => {
  ...
  if (!report) {
    ...
    return (
      <main className='loading-screen'>
        ...
        <p>Please generate a report or select one from Recent Reports.</p>
      </main>
    )
  }
  ...
  const technicalQuestions =
    normalizeQuestions(report).length > 0
      ? normalizeQuestions(report)
      : genericQuestions

  const behavioralQuestions =
    normalizeBehavioralQuestions(report).length > 0
      ? normalizeBehavioralQuestions(report)
      : genericQuestions
      ...
      <div className='interview-layout'>
        ...
        <aside className='interview-sidebar'>
          ...
          <div className='match-score'>
            ...
            <div className={`match-score__ring ${getScoreClass(score)}`}>
            ...
            <div className='skill-gaps__list'>
              ...
              {skillGaps.length > 0
                ? skillGaps.map((gap, idx) => (
                  <span
                    key={idx}
                    className={`skill-tag skill-tag--${gap.severity || 'neutral'}`}
                  >
